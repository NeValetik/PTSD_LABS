import { IAPIComponent } from '../models/IAPIComponent';
...
export class APIFacade {
  private userAPI: IAPIComponent;
  private productAPI: IAPIComponent;
  private orderAPI: IAPIComponent;

  constructor(
    userAPI: IAPIComponent,
    productAPI: IAPIComponent,
    orderAPI: IAPIComponent
  ) {
   ...
   */
  async createOrder(userId: string, productId: string, quantity: number): Promise<any> {
   ...
   */
  async getCompleteOrderDetails(orderId: string): Promise<any> {
